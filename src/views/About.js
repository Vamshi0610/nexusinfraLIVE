              ...
              <div className="col-md-12 section-t8 position-relative">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="color-text-a">
                      ...
                      each project is delivered on-time, and to your complete
                      satisfaction.{" "}
                    </p>
                    {/* <p className="color-text-a">
                  Sed porttitor lectus nibh. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus.
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <p className="color-text-a">
                      Enriching your ownership experience with strong focus on
                      quality at every stage of planning, development, and
                      delivery.
                    </p>
                    {/* <p className="color-text-a">
                  Sed porttitor lectus nibh. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus.
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="color-text-a">
                      We expanded beyond developing residential and commercial
                      properties to take the lead in hunting for the spaces for
                      our customers and plotting it as per their requirements.{" "}
                    </p>
                    {/* <p className="color-text-a">
                  Sed porttitor lectus nibh. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus.
                  Mauris blandit aliquet
